...
export function AuthProvider({children}: { children: ReactNode }) {
    ...
    const authActions = useMemo(
        () => ({
            signIn: async () => {   //TODO - insert the functionality in here
            ...
            signOut: () => { //TODO - insert the functionality in here
                dispatch({type: "SIGN_OUT"})
            },

            signUp: async (data: SignUpType) => { //TODO - insert the functionality in here
                /*
                userId,
                chosenAvatar,
                chosenBio,
